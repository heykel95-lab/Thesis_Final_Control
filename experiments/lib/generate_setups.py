...
#
# About t1: with r_c along +t2 the alignment component moved 0.08 deg over a
# set-up that moved 2.05 deg with no lever at all, so that direction cancels
# the correction. The assisting direction is -t2.
#
